...
DEMO.init_demo = function (my_name) {
  ...
  localStream = Erizo.Stream({audio: false, video: false, data: true, screen: false, videoSize:[1024, 640, 1024, 640], attributes: {name: my_name}});
  ...
  DEMO.create_token(my_name, "presenter", function (response) {
    ...
    screen_stream.addEventListener("access-accepted", function () {
      room.publish(screen_stream, {maxVideoBW: 2000});
